...
def load_data_from_file(sc: SparkContext):
    return sc.textFile("/Users/jeong-yoonjin/yeardream/Realtime/spark_practice/batch/data/user_visits.txt").map(lambda v: v.split(",")), \
        sc.textFile("/Users/jeong-yoonjin/yeardream/Realtime/spark_practice/batch/data/user_names.txt").map(lambda v: v.split(","))
...
if __name__ == '__main__':
    ...
    # 2. INNER JOIN, LEFT OUTER JOIN, RIGHT OUTER JOIN, FULL OUTER JOIN
